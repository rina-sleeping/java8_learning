...
class WorldTravelClock {
	 ...
	 * @return flight time
	 */
	public static Duration getFlightTime(String departure, String arrival,
			LocalTime departureTime, LocalTime arrivalTime) {
		return Duration.between(
				ZonedDateTime.of(tmp, departureTime, ZoneId.of(departure))
						.toInstant(),
				ZonedDateTime.of(tmp, arrivalTime, ZoneId.of(arrival))
						.toInstant());
